...
//         console.log(`Refunding ${refundAmount} to user ${user._id} for unmatched amount`)
...
//         // CRITICAL FIX: Ensure we're comparing strings correctly
...
//         console.log(`Bet ${bet._id} marked as unmatched`)
//       }
